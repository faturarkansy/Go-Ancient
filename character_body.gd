...
# Variabel untuk menyimpan status kunci
var key_status = false  # Default key_status = false

# Fungsi untuk mengubah status key_status saat mengambil kunci
func set_key_status(status: bool):
	key_status = status
